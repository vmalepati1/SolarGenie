...
def rotate_polygon(p, angle):
    ...
    src[src < 0] = 0
    obj = {}
    obj["all_points_x"] = src[0]
    obj["all_points_y"] = src[1]
    return obj
...
if __name__ == "__main__":
    inputfolder = "deeproof-release/data/deeproof"
    outfolder = "deeproof-release/data/final-dataset"
