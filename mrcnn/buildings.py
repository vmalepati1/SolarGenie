...
ROOT_DIR = os.getcwd()
if ROOT_DIR.endswith("samples/final-dataset"):
...
class BuildingDataset(utils.Dataset):
    ...
    def load_building(self, dataset_dir, subset):
        ...
        directions = ["N", "NNE", "NE", "ENE", "E", "ESE", "SE","SSE", "S", "SSW","SW","WSW", "W", "WNW", "NW", "NNW","tree"]
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect final-dataset.')
